...
disp("DBI SOLUTION");
disp("----------------------------");
disp("Max cl/cd: " + maxClOverCdIterate(iterNum));
disp("Velocity: " + v_dbi(iterNum));
disp("cl: " + bestcl(iterNum));
disp("S: " + bestS(iterNum));
disp("Wing loading: " + lift/bestS(iterNum));
disp("Chord: " + bestchord(iterNum));
disp("Aspect ratio: " + bestAR(iterNum));
...
disp("Velocity: " + velocity(maxOfMaxIndex));
disp("cl: " + bestcl(maxOfMaxIndex));
disp("S: " + bestS(maxOfMaxIndex));
disp("Wing loading: " + lift/bestS(maxOfMaxIndex));
disp("Chord: " + bestchord(maxOfMaxIndex));
disp("Aspect ratio: " + bestAR(maxOfMaxIndex));
disp("Load factor on turns: " + nIter);
if nIter > maxLoadFactorTurns + 0.001
    disp("Invalid solution! Load factor constraint not satisfied.");
end
